...
from model import MultiScale1DCNN   # 改进模型
...
def main():
    ...
    # ------------------------------------------------------
    # 构建改进模型 MultiScale1DCNN
    # ------------------------------------------------------
    model = MultiScale1DCNN(num_classes=4).to(device)
    ...
    model.load_state_dict(torch.load("multiscale_best.pth"))
